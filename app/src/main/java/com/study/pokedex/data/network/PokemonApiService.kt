...
import com.study.pokedex.data.model.PokemonList
import retrofit2.http.GET
import retrofit2.http.Path

interface PokemonApiService {
    /**
     * Returns a list of pokemons. Name and Url
     */
    @GET("pokemon")
    suspend fun getPokemons(): PokemonList

    /**
     * Returns info of a specific pokemon. @PokemonInfo can be changed to account for further details
     */
    @GET("pokemon/{name}")
    suspend fun getPokemonData(@Path("name") name: String): PokemonInfo
}

// PokeAPI official site: https://pokeapi.co/
// PokeAPI explorer: https://unpkg.com/css-chain-test@1.0.8/src/PokeApi-Explorer.html
// Pokemon sprites example
/*
{
    "sprites": {
